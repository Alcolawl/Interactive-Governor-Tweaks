...
echo ----------------------------------------------------
echo Applying 'Kestrel (Overclock)' v1.0 Interactive Governor Settings
echo ----------------------------------------------------
...
#Temporarily change permissions to governor files for the LITTLE cluster to overclock to 1632MHz
...
echo 85 460800:30 600000:65 672000:72 787200:78 864000:92 960000:95 1248000:98 1440000:98 1536000:95 1632000:100 > /sys/devices/system/cpu/cpu0/cpufreq/interactive/target_loads
...
#Temporarily change permissions to governor files for the Big cluster to overclock to 2016MHz
...
#Tweak Interactive Governor
echo 74 768000:73 864000:64 960000:80 1248000:61 1344000:69 1440000:64 1536000:74 1632000:69 1689600:67 1824000:72 1958400:75 2016000:80 > /sys/devices/system/cpu/cpu4/cpufreq/interactive/target_loads
